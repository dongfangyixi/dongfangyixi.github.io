...
the **floor**: the share of the target that remains undetermined *even with the best possible use of the input*. No predictor, however large or well-trained, can score below *B* on fresh data. (We'll write *B<sub>A</sub>* and *B<sub>V</sub>* for the action and vision heads' floors.)
